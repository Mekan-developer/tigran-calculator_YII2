    ...
    <div class="w-full max-w-3xl bg-white rounded-lg shadow-lg">
        ...
        <div class="p-8 space-y-6">
            <p class="text-gray-500 text-sm">
                Заполните форму ниже, чтобы добавить новый металл. Поля, отмеченные звездочкой (*), обязательны для заполнения.
            </p>
            ...
            <div class="bg-gray-50 border border-gray-200 p-6 rounded-lg space-y-4">
                ...
                <div class="flex justify-end">
                    ...
                    <?= Html::submitButton('Сохранить металл', [
