...
<head>
    ...
    <!-- Include Flowbite CSS from the local web folder -->
    <?= Html::cssFile('@web/css/flowbite.min.css') ?>
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="#" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">
                        ...
                        <i class="fa-solid fa-calculator flex-shrink-0 text-size-[20px] text-gray-400 transition duration-75 group-hover:text-white"></i>
                        <span class="flex-1 ms-3 whitespace-nowrap">Калькулятор </span>
